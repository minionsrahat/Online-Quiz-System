...
function CONVERT_TEXT_htmlentities_ENT_QUOTES($value,$con){
        $value = trim($value);
...
function CONVERT_TEXT_htmlentities_ENT_HTML5($value){
    $value = trim($value);
    // $value = mysqli_real_escape_string($con, $value);
    $value = htmlentities($value, ENT_HTML5, $encoding = 'UTF-8');
    // $value = '"' . $value . '"';
    return $value;
