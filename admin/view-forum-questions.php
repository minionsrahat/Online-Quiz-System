...
<body id="page-top">
                        ...
                        <div class="col-xl-10 col-lg-10 mx-auto">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Total Questions</h6>
                                ...
                                <div class="card-body col-12 mx-auto">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT COUNT(discussion_answers.question_id) as comments,users.fname as name,discussion_questions.title as title,discussion_questions.id as id, discussion_questions.date as date,discussion_questions.posted_by FROM discussion_questions LEFT join discussion_answers on discussion_questions.id=discussion_answers.question_id JOIN users
                                        ...
                                        GROUP by discussion_questions.id  ORDER by discussion_questions.date DESC  ";
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="delete.php?table=discussion_questions&col_name=id&id=<?php echo $row['id'] ?>" class="btn btn-danger text-white"> Delete</a></td>
                                                </tr>
    ...
    <div class="modal fade" id="editmodel" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit questions information</h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="">Ques title</label>
                        <input type="text" class="form-control" name="" id="ques_title" aria-describedby="helpId" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="">Cat Id</label>
                        <input type="text" class="form-control" name="" id="cat_id" aria-describedby="helpId" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="">Ans Id</label>
                        <input type="text" class="form-control" name="" id="ans_id" aria-describedby="helpId" placeholder="">
                    </div>
                </div>
                <div class="modal-footer">
                </div>
