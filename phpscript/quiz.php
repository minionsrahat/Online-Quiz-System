        ...
        <div class="row mt-4">
            ...
            <div class="col-lg-6 col-md-12 center-col col-12">
                <div class="center-div">
                    ...
                    <form action="result.php?limit=5&cat_id=<?php echo $cat_id?>" method="post">
                        <div class="row ">
                            <div class="col-10 mx-auto">
                                <div class="loader">

                                    <?php
                            $quesql="SELECT * FROM `questions` where cat_id='$cat_id' ORDER BY RAND() LIMIT 5";
                            ...
                            ?>
                                    <div class="mt-2 p-3" id="quiz">
                                        <div class="question mb-3">
                                            <p class="text-center"><span class= "badge badge-primary" id="qid"><?php echo $id; $id++;?></span>.
                                        ...
                                        ?>
                                            <li>
                                                ...
                                                <label for="f-option"
                                                    class="element-animation"><?php echo $opt_row['option_det']; ?></label>
                                                <div class="check"></div>
                                            </li>
                                            <?php
                                         $i=$i+1;
                        ...
                        <div class="row">
                            <button name="submit" id="" class="btn btn-primary mx-auto" href="#" role="button">Finished
                                quiz</button>
                        </div>
                    </form>
